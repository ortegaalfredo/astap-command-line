...
var {################# initialised variables #########################}
  ...
  version: string=' CLI-0.9.581-stack dated 2021-10-1';
  ra1  : string='0';
  dec1 : string='0';
...
begin
 ...
 {update FITs header}
  ...
  if type1=8 then
  begin
    minimum:=0;//min(0,mainwindow.minimum1.position); {stretch later if required}
    maximum:=255;//max(255,mainwindow.maximum1.position);
...
var
  TheFile4 : tfilestream;
  I,j,k,bzero2, dum, remain,minimum,maximum,dimensions, naxis3_local,height5,width5 : integer;
  dd : single;
  line0                : ansistring;
  aline,empthy_line    : array[0..80] of ansichar;{79 required but a little more to have always room}
  rgb  : byteX3;{array [0..2] containing r,g,b colours}
